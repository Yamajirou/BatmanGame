...
public class BodyImageActor3 {

	private Body body = null;
	private AnimatedActorHero animatedActor = null;
	private float defaultFrameDuration = 0.25f;
//	private Stage stage = null;
	
	public BodyImageActor3(World world, BodyDef def, FixtureDef fixturedef, GeneralUserData data, Stage stage, Texture texture, int rows, int cols, float frameDuration) {
		animatedActor = new AnimatedActorHero(frameDuration, texture, cols, rows);
		this.createActor(stage, world, def, fixturedef, data);
	}
	
	public BodyImageActor3(World world, BodyDef def, FixtureDef fixturedef, GeneralUserData data, Stage stage, Texture texture, int rows, int cols, int frameQtd, float frameDuration) {
		animatedActor = new AnimatedActorHero(frameDuration, texture, cols, rows, frameQtd);
		this.createActor(stage, world, def, fixturedef, data);
	}
	
	public BodyImageActor3(World world, BodyDef def, FixtureDef fixturedef, GeneralUserData data, Stage stage, Texture texture, int rows, int cols, int frameQtd) {
		animatedActor = new AnimatedActorHero(defaultFrameDuration, texture, cols, rows, frameQtd);
		this.createActor(stage, world, def, fixturedef, data);
	}
	
	public BodyImageActor3(World world, BodyDef def, FixtureDef fixturedef, GeneralUserData data, Stage stage, Texture texture, int rows, int cols) {
		animatedActor = new AnimatedActorHero(defaultFrameDuration, texture, cols, rows);
		this.createActor(stage, world, def, fixturedef, data);
	}
	
	public BodyImageActor3(World world, BodyDef def, FixtureDef fixturedef, GeneralUserData data, Stage stage, Array<? extends TextureRegion> keyFrames) {
		animatedActor = new AnimatedActorHero(defaultFrameDuration, keyFrames);
		this.createActor(stage, world, def, fixturedef, data);
	}
	
	public BodyImageActor3(World world, BodyDef def, FixtureDef fixturedef, GeneralUserData data, Stage stage, TextureRegion... textures) {
		animatedActor = new AnimatedActorHero(defaultFrameDuration, textures);
		this.createActor(stage, world, def, fixturedef, data);
	}
	...
	public AnimatedActorHero getAnimatedActor(){
