...
public class AnimatedComplexActor extends Actor {
...
//    private float frameDuration = 0.025f; // default
    ...
    public AnimatedComplexActor(String filePath, int frameQt, int frameCols, int frameRows, float frameDuration, int idleFrame) {
    	this(filePath, frameQt, frameCols, frameRows, frameDuration);
    	idleSprite = idleFrame;
    }
    
    public AnimatedComplexActor(String filePath, int frameQt, int frameCols, int frameRows, float frameDuration) {
//    	super(tex);
    	super();
